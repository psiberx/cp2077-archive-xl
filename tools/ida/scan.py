        ...
        Output(filename="src/Red/Addresses.hpp", namespace="Red::Addresses", groups=[
            ...
            Group(name="CharacterCustomizationSystem", functions=[
                ...
                Item(name="InitializeAppOption",
                     pattern="48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC ? 48 8B F1 44 8B FA 49 8B 08"),
...
#             ]),
            Group(name="TPPRepresentationComponent", functions=[
                Item(name="OnAttach",
                     pattern="48 89 5C 24 ? 48 89 74 24 ? 55 57 41 56 48 8B EC 48 83 EC ? 66 83 89 ? ? ? ? 02 48 8B FA 48 8B F1 E8 ? ? ? ? BA"),
