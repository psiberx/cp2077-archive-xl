...
#                      index=1),
            ...
            Group(name="CharacterCustomizationHairstyleController", functions=[
                Item(name="OnDetach",
                     pattern="40 55 53 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 81 ? ? ? ? 0F 57 C0 48 8B FA 48 8B D9"),
                Item(name="CheckState",
            ...
            Group(name="GarmentAssembler", functions=[
                ...
                Item(name="ProcessGarment",
                     pattern="4C 8B DC 49 89 5B ? 49 89 6B ? 49 89 73 ? 57 48 83 EC ? 66 41 C7 43 ? 00 00 49 8B F8 41 0F B7 43"),
                Item(name="ProcessSkinnedMesh",
                     pattern="48 89 5C 24 ? 48 89 6C 24 ? 56 57 41 54 41 56 41 57 48 81 EC ? ? ? ? 48 8B E9 8B FA 49 8B 09"),
                Item(name="ProcessMorphedMesh",
                     pattern="48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 4C 8B F9 44 8B F2"),
