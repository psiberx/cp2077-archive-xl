...
constexpr uintptr_t InkSpawner_SpawnFromExternal = 0x1409C7830 - ImageBase; // 48 89 5C 24 08 48 89 74 24 10 48 89 7C 24 18 55 41 56 41 57 48 8D 6C 24 C1 48 81 EC F0 00 00 00, expected: 1, index: 0
