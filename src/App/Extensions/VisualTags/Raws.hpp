...
using GetVisualTags = Core::RawFunc<
    /* address = */ Addresses::AppearanceNameVisualTagsPreset_GetVisualTags,
...
using MergeTagLists = Core::RawFunc<
    /* address = */ Addresses::TagList_MergeWith,
