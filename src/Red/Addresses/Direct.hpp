...
// Generated by cp77ida.py on 2024-02-01 for Cyberpunk 2077 v.2.11
...
constexpr uintptr_t AttachmentSlots_IsSlotEmpty = 0x1404BFE54 - ImageBase; // 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8D B9 ? ? ? ? 48 8B F1 48 8B CF 48 8B DA E8 ? ? ? ? 48 8B D3 48 8B CE E8 ? ? ? ? 33 ? 48 85 C0 74, expected: 3, index: 1
constexpr uintptr_t AttachmentSlots_IsSlotSpawning = 0x1404BC1D0 - ImageBase; // 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8D B9 ? ? ? ? 48 8B F1 48 8B CF 48 8B DA E8 ? ? ? ? 48 8B D3 48 8B CE E8 ? ? ? ? 33 ? 48 85 C0 74, expected: 3, index: 0
