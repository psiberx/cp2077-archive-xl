...
// Generated by cp77ida.py on 2023-03-06 for Cyberpunk 2077 v.1.61
...
constexpr uintptr_t AppearanceChangeSystem_ChangeAppearance = 0x1411305E0 - ImageBase; // 4C 8B DC 49 89 53 10 49 89 4B 08 55 53 56 41 54 41 57 49 8D AB 58 FE FF FF 48 81 EC 80 02 00 00, expected: 1, index: 0
...
constexpr uintptr_t CharacterCustomizationHelper_GetHairColor = 0x141BEE2C0 - ImageBase; // 40 55 41 56 41 57 48 8B EC 48 83 EC 50 4C 8B F9 48 8B 0A 48 8D 55 D8 48 8B 01 FF 90 E8 01 00 00, expected: 1, index: 0

constexpr uintptr_t CharacterCustomizationSystem_Initialize = 0x1424E92D0 - ImageBase; // 48 8B C4 44 88 40 18 48 89 50 10 55 56 48 8D 68 A1 48 81 EC E8 00 00 00 48 89 58 20 4C 89 68 D8, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationSystem_Uninitialize = 0x1424E73D0 - ImageBase; // 40 53 56 57 48 83 EC 50 48 8B F1 48 83 C1 78 E8 ? ? ? ? 48 8B 86 F8 00 00 00 33 FF 0F 57 C0, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationSystem_EnsureState = 0x1424D79B0 - ImageBase; // 48 8B C4 55 41 57 48 8D A8 38 FF FF FF 48 81 EC B8 01 00 00 48 89 58 08 48 89 78 20 48 8B F9, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationSystem_InitializeAppOption = 0x1424DE700 - ImageBase; // 4C 8B DC 48 81 EC 98 00 00 00 49 89 5B 08 49 8B D9 49 89 73 F8 48 8B F1 49 8B 08 4D 89 63 E8, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationSystem_InitializeMorphOption = 0x1424DF630 - ImageBase; // 48 8B C4 55 57 48 8D 68 A1 48 81 EC D8 00 00 00 48 89 58 08 49 8B D8 4C 89 60 20 4D 8B E1, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationSystem_InitializeSwitcherOption = 0x1424E08D0 - ImageBase; // 48 8B C4 44 89 48 20 4C 89 40 18 89 50 10 55 41 57 48 8D 68 B1 48 81 EC E8 00 00 00 48 89 70 E8, expected: 1, index: 0

constexpr uintptr_t CMesh_GetAppearance = 0x140A0FE50 - ImageBase; // 40 53 48 83 EC 20 4C 8B 81 E0 01 00 00 48 8B D9 8B 81 EC 01 00 00 48 C1 E0 04 49 03 C0 4C 3B C0, expected: 1, index: 0
...
constexpr uintptr_t JobHandle_Wait = 0x142C15650 - ImageBase; // 40 53 48 83 EC 30 48 8B D9 33 D2 48 8B 0D BE BB 07 02 E8, expected: 1, index: 0

constexpr uintptr_t JournalManager_LoadJournal = 0x142027360 - ImageBase; // 48 89 5C 24 20 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 D9 48 81 EC D0 00 00 00 4C 8B E2, expected: 1, index: 0
constexpr uintptr_t JournalManager_GetEntryHash = 0x142025600 - ImageBase; // 48 89 5C 24 10 48 89 6C 24 18 48 89 74 24 20 57 48 83 EC 20 33 F6 48 8B EA 8B DE 48 8B F9 66 90, expected: 1, index: 0
constexpr uintptr_t JournalManager_GetEntryByHash = 0x1420249E0 - ImageBase; // 48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 56 48 83 EC 20 33 F6 41 8B E8, expected: 1, index: 0
constexpr uintptr_t JournalManager_GetTrackedQuest = 0x1420262B0 - ImageBase; // 48 8B 81 10 01 00 00 48 89 02 48 8B 81 18 01 00 00 48 89 42 08 48 85 C0 74 ? F0 FF 00 48 8B C2, expected: 1, index: 0
constexpr uintptr_t JournalManager_GetTrackedPointOfInterest = 0x142026280 - ImageBase; // 48 8B 81 20 01 00 00 48 89 02 48 8B 81 28 01 00 00 48 89 42 08 48 85 C0 74 ? F0 FF 00 48 8B C2, expected: 1, index: 0
constexpr uintptr_t JournalManager_TrackQuest = 0x14202E430 - ImageBase; // 48 89 54 24 10 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 18 FF FF FF 48 81 EC E8 01 00 00 48 8B 1A 45 32 ED 4C 8B F2 48 8B F1, expected: 1, index: 0
constexpr uintptr_t JournalManager_TrackPointOfInterest = 0x141369910 - ImageBase; // 48 81 C1 20 01 00 00 E9, expected: 8, index: 0

constexpr uintptr_t JournalRootFolderEntry_Initialize = 0x142011F30 - ImageBase; // 48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 4D 8B C1 49 8B F1 48 8B DA 48 8B F9 E8, expected: 1, index: 0

constexpr uintptr_t JournalTree_ProcessJournalIndex = 0x142042810 - ImageBase; // 48 89 4C 24 08 55 41 56 48 81 EC B8 00 00 00 4C 8B F1 48 8B EA 48 8B 49 08 E8, expected: 1, index: 0
...
constexpr uintptr_t MappinResource_GetMappinData = 0x14245A7D0 - ImageBase; // 48 8B 41 40 8B 49 4C 48 C1 E1 05 48 03 C8 48 3B C1 74, expected: 1, index: 0

constexpr uintptr_t MeshAppearance_LoadMaterialSetupAsync = 0x140A17E90 - ImageBase; // 40 55 53 56 57 41 55 41 57 48 8D AC 24 78 FF FF FF 48 81 EC 88 01 00 00 45 0F B6 E8 48 8B F2 4C, expected: 1, index: 0

constexpr uintptr_t ResourceLoader_OnUpdate = 0x140204860 - ImageBase; // 48 8B 49 48 48 85 C9 0F 85, expected: 9, index: 2

constexpr uintptr_t StreamingWorld_OnLoad = 0x140B94170 - ImageBase; // 48 89 5C 24 08 57 48 83 EC 40 48 8B FA 48 8B D9 E8 ? ? ? ? 0F 57 C0 48 8D 93 D8 01 00 00, expected: 1, index: 0
