...
// Generated by cp77ida.py on 2023-10-21 for Cyberpunk 2077 v.2.01
...
constexpr uintptr_t StreamingSector_OnReady = 0x14027BCDC - ImageBase; // 48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B 91 ? ? ? ? 33 FF 48 8B D9, expected: 1, index: 0
...
constexpr uintptr_t TPPRepresentationComponent_IsAffectedSlot = 0x1408988D4 - ImageBase; // 48 89 4C 24 ? 48 8D 15 ? ? ? ? 48 8B 02 3B C1 75 ? 48 C1 E8 ? 3A 44 24 ? 74, expected: 1, index: 0
