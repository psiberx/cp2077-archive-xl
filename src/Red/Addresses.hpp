...
// Generated by cp77ida.py on 2022-12-16 for Cyberpunk 2077 v.1.61
...
constexpr uintptr_t TPPRepresentationComponent_OnInitialize = 0x141A94E60 - ImageBase; // 48 8B C4 55 56 48 8D 68 98 48 81 EC 58 01 00 00 8B 15 ? ? ? ? 48 89 58 10 48 89 78 E8, expected: 1, index: 0
}
