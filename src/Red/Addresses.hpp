...
// Generated by cp77ida.py on 2023-08-10 for Cyberpunk 2077 v.1.63
...
constexpr uintptr_t CharacterCustomizationGenitalsController_OnAttach = 0x1424DFC90 - ImageBase; // 48 89 5C 24 ? 57 48 83 EC ? 48 8B F9 48 8B DA 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8B D3 48 8B CF, expected: 1, index: 0
constexpr uintptr_t CharacterCustomizationGenitalsController_CheckState = 0x1424DE0F0 - ImageBase; // 4C 89 44 24 ? 48 89 54 24 ? 48 89 4C 24 ? 55 53 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 01 4C 8B E2 45 33 ED, expected: 1, index: 0

constexpr uintptr_t CharacterCustomizationHairstyleController_OnDetach = 0x1424E1B10 - ImageBase; // 40 55 53 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 81 ? ? ? ? 0F 57 C0 48 8B FA 48 8B D9, expected: 1, index: 0
...
constexpr uintptr_t ItemFactoryAppearanceChangeRequest_LoadTemplate = 0x141C56460 - ImageBase; // 48 89 5C 24 18 48 89 74 24 20 55 57 41 56 48 8D 6C 24 B9 48 81 EC C0 00 00 00 45 32 F6 48 8B F9, expected: 1, index: 0
constexpr uintptr_t ItemFactoryAppearanceChangeRequest_LoadAppearance = 0x141C56200 - ImageBase; // 40 55 57 41 56 48 8B EC 48 81 EC ? ? ? ? 48 89 B4 24 ? ? ? ? 45 32 F6 48 8B F1 48 8B 49, expected: 1, index: 0

constexpr uintptr_t ItemFactoryRequest_LoadAppearance = 0x141C4F260 - ImageBase; // 40 55 56 41 56 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 89 BC 24 ? ? ? ? 45 32 F6 48 8B F9 48 8B 49, expected: 1, index: 0
