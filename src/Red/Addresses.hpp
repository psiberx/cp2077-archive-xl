...
constexpr uintptr_t Localization_LoadLipsyncs = 0x14237EFA0 - ImageBase; // 48 89 5C 24 10 48 89 74 24 20 57 48 83 EC 50 48 8B F1 0F B6 FA 48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8B D8 48 8D 48 20 E8, expected: 1, index: 0
